...
# this file: *treated*, cytokine expressing memory *CD8* T cells, batch *data 23* only
...
dataset <- "panel2_CD8_Tmem_cells_treated_data23"
...
fn_panel <- "../../data/PD-1 project/CK_panels/panel2CD8_23_cytokines.xlsx"  # identical for 'data 23' and 'data 29'
