...
# 
# - panel: "panel2.xlsx"
# - data: batches "data 23" and "data 29", treated, Non-Responders vs. Responders
# 
...
# this file: *treated*, cytokine expressing memory *CD8* T cells, batch *data 29* only
...
dataset <- "panel2_CD8_Tmem_cells_treated_data29"
...
path_23 <- "../../data/PD-1 project/CK_2016-06-23_02_CD8_merging2_Tmem_merging2_CD69/010_cleanfcs"
path_29 <- "../../data/PD-1 project/CK_2016-06-29_02_CD8_merging_Tmem_merging3_CD69/010_cleanfcs"

fn_panel <- "../../data/PD-1 project/CK_panels/panel2CD8_29_cytokines.xlsx"  # identical for 'data 23' and 'data 29'
...
condition <- gsub("^tx_", "", c(metadata_23$condition[ix_keep], metadata_29$condition[ix_keep]))
condition

# vector of sample IDs
samples <- gsub("^tx_", "", c(metadata_23$shortname[ix_keep], metadata_29$shortname[ix_keep]))
samples
...
plotMDS(df_plot, top = 2000, col = cols_cnd_bch, 
        main = "MDS plot: \ncondition (NR vs. R) and \nbatch (data treated_23 vs. data treated_29)")
legend("bottomright", pch = 16, 
       legend = c("Non responder (NR), data treated_23", "Responder (R), data treated_23", 
                  "Non responder (NR), data treated_29", "Responder (R), data treated_29"), 
       col = pal)
