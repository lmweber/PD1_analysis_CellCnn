...
# this file: *treated*, cytokine expressing memory *CD4* T cells, batch *data 29* only
...
dataset <- "panel2_CD4_Tmem_cells_treated_data29"
...
fn_panel <- "../../data/PD-1 project/CK_panels/panel2CD4_29_cytokines.xlsx"  # identical for 'data 23' and 'data 29'
